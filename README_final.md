...
Este projeto tem como objetivo analisar reclamações de consumidores utilizando técnicas de Processamento de Linguagem Natural (NLP) e aprendizado de máquina.
